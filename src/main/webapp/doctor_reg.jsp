...
<head>
  ...
  <link rel="stylesheet" href="css/common.css">
   <link rel="stylesheet" href="css/petOwner_reg.css">
...
<body>
    ...
    <div class="outer">
        ...
        <div class="inner">
        <form action="./doctorRegisterServlet" method="post" id="reg-form"
        enctype="multipart/form-data">
           ...
           <main class="Signup-body">
            ...
            <p>
                ...
                <input type="text" id="specialization" placeholder="" name="specialization" required="required">
            </p>
            <p>
                <Label for="Certificate">Upload Degree Certificate</Label>
                <input type="file" id="Certificate" name="certificate" required="required" accept=".pdf, image/*">
            </p>
            <p>
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            if (data.trim() === 'done')
                            {
                                ...
                                swal("Registered Successfully")
                                        .then((value) => {
                                            window.location = "doctor_waiting.jsp" 
                                        });
                            } else
                            {
