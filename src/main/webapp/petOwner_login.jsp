...
<head>
   ...
   <link rel="stylesheet" href="css/petOwner_login.css?v=2">
</head>
<body>
    ...
    <div class="outer">
        ...
        <form action="./petOwnerLoginServlet" method="post">
            <header>
        ...
        <p>Don't have an Account?<a href="petOwner_reg.jsp">Register</a></p>
        </footer>
        </div>
